...
process.outputFile.name = cms.string("signalMadgraphNoPU.root")
process.zmumueff.TrainUnfolding = cms.bool(False)
process.zmumugen.ScaleFactor=cms.double(3048./2429376) #inclusive cross section from https://twiki.cern.ch/twiki/bin/view/CMS/StandardModelCrossSections
process.zmumurec.ScaleFactor=cms.double(3048./2429376)
process.zmumueff.ScaleFactor=cms.double(3048./2429376)
