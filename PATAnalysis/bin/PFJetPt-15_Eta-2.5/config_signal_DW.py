...
process.outputFile.name = cms.string("signalDW.root")
process.zmumueff.TrainUnfolding = cms.bool(False)
process.zmumugen.ScaleFactor=cms.double(1667./2139555) #inclusive cross section from MCFM
process.zmumurec.ScaleFactor=cms.double(1667./2139555)
process.zmumueff.ScaleFactor=cms.double(1667./2139555)
