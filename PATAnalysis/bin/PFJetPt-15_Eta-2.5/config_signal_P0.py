...
process.outputFile.name = cms.string("signalP0.root")
process.zmumueff.TrainUnfolding = cms.bool(False)
process.zmumugen.ScaleFactor=cms.double(1667./2122500) #inclusive cross section from MCFM
process.zmumurec.ScaleFactor=cms.double(1667./2122500)
process.zmumueff.ScaleFactor=cms.double(1667./2122500)
