...
process.outputFile.name = cms.string("signalProQ20.root")
process.zmumueff.TrainUnfolding = cms.bool(False)
process.zmumugen.ScaleFactor=cms.double(1667./2172000) #inclusive cross section from MCFM
process.zmumurec.ScaleFactor=cms.double(1667./2172000)
process.zmumueff.ScaleFactor=cms.double(1667./2172000)
