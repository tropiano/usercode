...
int main(int argc, char *argv[]) {
	...
	string SourceFilesDir			= "/raid/sandro/Analisi/rel_CMSSW_4_2_5_TeP/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/SourceFilesMuons/";
	...
	string path="/raid/sandro/Analisi/rel_CMSSW_4_2_5_TeP/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/AnalysisMuons/";
