...
void TPPlots(string multiplicity, string selections){
        ...
        TFile *signal_MC_file = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/MonteCarlo/Train/DYtoLL_Train.root");
        
        TFile *tp_12, *tp_123, *tp_1234, *tp_12345, *tp_123456, *tp_global;
        
        if(Fits){
        //TP files (outputs of TagAndProbeAnalyzer) whit the mass fits
        tp_12 = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        tp_123 = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        tp_1234 = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        tp_12345 = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        tp_123456 = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        tp_global = TFile::Open("/data/sfrosali/Zjets/CMSSW_4_2_5/src/Firenze/PATAnalysis/bin/TagProbe/MC-DATA_Sample_Excl_Global.root");
        }
        
        //Output
        string out = "TPStudy_DYtoLL_SYM_WithFits";
        string output = out;
        output+=".root";
        TFile* outplots = new TFile(output.c_str(), "RECREATE");
        
        ofstream tpr;
	string outtpr="TPReport_DYtoLL_SYM_WithFits.txt";
...
TP_global = TP->mkdir("Tag&Probe_Global");
   ...
   /*if(multiplicity=="excl")RelEffDenom_MC = (TH1D*) signal_MC_file->Get("EfficiencyMuon/EffDenom_GenExclJetNumber");
   if(multiplicity=="incl")RelEffDenom_MC = (TH1D*) signal_MC_file->Get("EfficiencyMuon/EffDenom_GenInclJetNumber");*/
   
   if(multiplicity=="excl")RelEffDenom_MC = (TH1D*) signal_MC_file->Get("EfficiencyMuon/EffDenom_RecoExclJetNumber");
   if(multiplicity=="incl")RelEffDenom_MC = (TH1D*) signal_MC_file->Get("EfficiencyMuon/EffDenom_RecoInclJetNumber");

	string MCJetEff_name;
	if(multiplicity=="excl")MCJetEff_name = "EfficiencyMuon/RecoExclJetEff";
	if(multiplicity=="incl")MCJetEff_name = "EfficiencyMuon/RecoInclJetEff";
	...
	//MC: Reco(AllCuts)/Reco(Acc) - NB: il TP si confronta con questo  
        ...
        string TPDir="EfficiencyMuon/Tag&Probe";
        string TPHisto="/Muon";        
        if(selections=="ASYM")TPDir="EfficiencyMuon/Tag&Probe0";
        ...
        TPDir="EfficiencyMuon/Tag&Probe";        
        if(selections=="ASYM")TPDir="EfficiencyMuon/Tag&Probe0";
        ...
        string TPDir1="EfficiencyMuon/Tag&Probe1";
        ...
        TPDir1="EfficiencyMuon/Tag&Probe1";
        ...
        if(Fits){
        tp_eff_12 = (TGraphAsymmErrors*) tp_12->Get("FitDoubleTag&Probe");
        tp_eff_123 = (TGraphAsymmErrors*) tp_123->Get("FitDoubleTag&Probe");
        tp_eff_1234 = (TGraphAsymmErrors*) tp_1234->Get("FitDoubleTag&Probe");
        tp_eff_12345 = (TGraphAsymmErrors*) tp_12345->Get("FitDoubleTag&Probe");
        tp_eff_123456 = (TGraphAsymmErrors*) tp_123456->Get("FitDoubleTag&Probe");
        tp_eff_global = (TGraphAsymmErrors*) tp_global->Get("FitDoubleTag&Probe");}
        ...
        if(selections=="ASYM")Eff_TP_Single1_12.Write();
        Eff_TP_Double_12.Write();
        if(Fits)tp_eff_12->Write("TP_Data-Eff_12");
	...
	if(Fits)tp_eff_12->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	Error High = "<<((float)((int)(tp_eff_12->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_12->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
	...
	TP_denominator_123->Write();
        ...
        if(selections=="ASYM")Eff_TP_Single1_123.Write();
        Eff_TP_Double_123.Write();
        if(Fits)tp_eff_123->Write("TP_Data-Eff_123");
	...
	if(Fits)tp_eff_123->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	Error High = "<<((float)((int)(tp_eff_123->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_123->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
	...
	TP_denominator_1234->Write();
        ...
        if(selections=="ASYM")Eff_TP_Single1_1234.Write();
        Eff_TP_Double_1234.Write();
        if(Fits)tp_eff_1234->Write("TP_Data-Eff_1234");
	...
	if(Fits)tp_eff_1234->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	ErrorHigh = "<<((float)((int)(tp_eff_1234->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_1234->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
	...
	TP_denominator_12345->Write();
        ...
        if(selections=="ASYM")Eff_TP_Single1_12345.Write();
        Eff_TP_Double_12345.Write();
        if(Fits)tp_eff_12345->Write("TP_Data-Eff_12345");
	...
	if(Fits)tp_eff_12345->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	ErrorHigh = "<<((float)((int)(tp_eff_12345->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_12345->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
	...
	TP_denominator_123456->Write();
        ...
        if(selections=="ASYM")Eff_TP_Single1_123456.Write();
        Eff_TP_Double_123456.Write();
        if(Fits)tp_eff_123456->Write("TP_Data-Eff_123456");
	...
	if(Fits)tp_eff_123456->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	ErrorHigh = "<<((float)((int)(tp_eff_123456->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_123456->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
	...
	TP_denominator_global->Write();
        ...
        if(selections=="ASYM")Eff_TP_Single1_global.Write();
        Eff_TP_Double_global.Write();
        if(Fits)tp_eff_global->Write("TP_Data-Eff_Global");
	...
	if(Fits)tp_eff_global->GetPoint(i,xDATA,yDATA);
	...
	if(Fits){tpr<<"		DATA TP =	"<<((float)((int)(yDATA*cut_decimal)))/cut_decimal<<"	ErrorHigh = "<<((float)((int)(tp_eff_global->GetErrorYhigh(i)*cut_decimal)))/cut_decimal<<"	Error Low = "<<((float)((int)(tp_eff_global->GetErrorYlow(i)*cut_decimal)))/cut_decimal<<endl;}
	cout<<endl;
	}
