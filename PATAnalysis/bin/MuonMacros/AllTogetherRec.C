...
//	string Address_Vertex = "Vertex_Great8/";
	...
	if (Address_Vertex == "Vertex_Less8/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Less8/recoJetCounterTrue_VertWindA"; 
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Less8/recoJetTotalCounter_VertWindA"; 
	}
	else if (Address_Vertex == "Vertex_Great8/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Great8/recoJetCounterTrue_VertWindB";
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Great8/recoJetTotalCounter_VertWindB";
	}
	else if (Address_Vertex == "Vertex_NoRequirement/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_No/recoJetCounterTrue";
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_No/recoJetTotalCounter";
	}
...
//	string Address_IsoRho = "IsoRho_NO/"; 
	...
	string pre_file_out = "AllTogetherRec"; 
...
//	histo_1_Excl->SetTitle(Title_Excl.c_str());
	...
	histo_1_Excl->GetYaxis()->SetTitle("Ratio");
        histo_1_Excl->GetYaxis()->SetTitleOffset(1.7);
	...
	TLegend *Leg_Excl = new TLegend(0.23,0.63,0.81,0.88);
...
//	TPaveText *Tex_Excl = new TPaveText(0.11,0.04,1.94,0.05);
	TPaveText *Tex_Excl = new TPaveText(0.23,0.5,0.463935,0.594,"NDC");
...
//	histo_1_Incl->SetTitle(Title_Incl.c_str());
	...
	histo_1_Incl->GetYaxis()->SetTitle("Ratio");
        histo_1_Incl->GetYaxis()->SetTitleOffset(1.7);
	...
	TLegend *Leg_Incl = new TLegend(0.23,0.63,0.81,0.88);
...
//	TPaveText *Tex_Incl = new TPaveText(0.11,0.04,1.94,0.05);
	TPaveText *Tex_Incl = new TPaveText(0.23,0.5,0.463935,0.594,"NDC");
