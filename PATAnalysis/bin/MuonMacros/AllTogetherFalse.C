...
//	string Address_Vertex = "Vertex_Great8/";
	...
	if (Address_Vertex == "Vertex_Less8/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Less8/numCounterFalse_VertWindA"; 
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Less8/denCounterFalse_VertWindA"; 
	}
	else if (Address_Vertex == "Vertex_Great8/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Great8/numCounterFalse_VertWindB";
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_Great8/denCounterFalse_VertWindB";
	}
	else if (Address_Vertex == "Vertex_NoRequirement/"){
		histo_NUM_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_No/numCounterFalse";
		histo_DEN_Vertex = "DeltaRAnalyzerMuon/DoubleMu_Overlap/VerticesCut_No/denCounterFalse";
	}
...
//	string Address_IsoRho = "IsoRho_NO/"; 
	...
	string post_Address_in = "genJets/genJetsFalse/";
	...
	string pre_file_in = "genJetsFalse";
	...
	string pre_file_out = "AllTogetherFalse"; 
	...
	string Title_Incl = "Inclusive Jet Rate: Efficiency";
        ...
        string Insieme = "AllTogetherFalse";
...
//	TPaveText *Tex_Excl = new TPaveText(-0.08,0.52,1.89,0.58);
...
//	TPaveText *Tex_Incl = new TPaveText(-0.08,0.52,1.89,0.58,"NDC");
