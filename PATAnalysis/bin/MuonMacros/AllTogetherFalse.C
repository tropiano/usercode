...
// For the frame:
  ...
  gStyle->SetFrameLineWidth(1);
	...
	//uno
	TFile *file_1 = TFile::Open("genJetsFalse_DeltaR_0e0.root");
	//due
	TFile *file_2 = TFile::Open("genJetsFalse_DeltaR_0e2.root");
	//tre
	TFile *file_3 = TFile::Open("genJetsFalse_DeltaR_0e3.root");
	//quattro
	TFile *file_4 = TFile::Open("genJetsFalse_DeltaR_0e4.root");
	//cinque
	TFile *file_5 = TFile::Open("genJetsFalse_DeltaR_0e5.root");


	//Output
	string out = "InsiemeFalse";        
	...
	TLegend *Leg_Excl = new TLegend(0.36,0.63,0.88,0.88);
	...
	TLegend *Leg_Incl = new TLegend(0.36,0.63,0.88,0.88);
