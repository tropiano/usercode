...
Dir_5a->cd();
	...
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_EMEnriched_all_1->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_QCD_BCtoE_all.c_str();
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_BCtoE_all_1->GetBinContent(i)*decimal)))/decimal<<"	";
	...
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWlnu_1->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_WWEE.c_str();
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWWEE_1->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_WZEE.c_str();
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWZEE_1->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_ZZEE.c_str();
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZZEE_1->GetBinContent(i)*decimal)))/decimal<<"	";
	...
	for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_1->GetBinContent(i) + histoQCD_BCtoE_all_1->GetBinContent(i) + histoTTbar_1->GetBinContent(i) + histoWlnu_1->GetBinContent(i) + histoWWEE_1->GetBinContent(i) + histoWZEE_1->GetBinContent(i) + histoZZEE_1->GetBinContent(i) + histoZ_1->GetBinContent(i))*decimal)))/decimal<<"	";
	...
	c_12->Close();
		...
		if(Tab_jetm == "True"){
			...
			jetm<<endl<<Tab_title.c_str()<<endl;
			jetm<<endl<<Tab_QCD_EMEnriched_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_EMEnriched_all_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_BCtoE_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_BCtoE_all_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_TTbar.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoTTbar_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Wlnu.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWlnu_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WWEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWWEE_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWZEE_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_ZZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZZEE_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Z.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZ_12->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_riga.c_str();
			jetm<<endl<<Tab_total.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_12->GetBinContent(i) + histoQCD_BCtoE_all_12->GetBinContent(i) + histoTTbar_12->GetBinContent(i) + histoWlnu_12->GetBinContent(i) + histoWWEE_12->GetBinContent(i) + histoWZEE_12->GetBinContent(i) + histoZZEE_12->GetBinContent(i) + histoZ_12->GetBinContent(i))*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Data.c_str();
	...
	c_123->Close();
		...
		if(Tab_jetm == "True"){
			...
			jetm<<endl<<Tab_title.c_str()<<endl;
			jetm<<endl<<Tab_QCD_EMEnriched_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_EMEnriched_all_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_BCtoE_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_BCtoE_all_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_TTbar.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoTTbar_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Wlnu.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWlnu_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WWEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWWEE_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWZEE_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_ZZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZZEE_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Z.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZ_123->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_riga.c_str();
			jetm<<endl<<Tab_total.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_123->GetBinContent(i) + histoQCD_BCtoE_all_123->GetBinContent(i) + histoTTbar_123->GetBinContent(i) + histoWlnu_123->GetBinContent(i) + histoWWEE_123->GetBinContent(i) + histoWZEE_123->GetBinContent(i) + histoZZEE_123->GetBinContent(i) + histoZ_123->GetBinContent(i))*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Data.c_str();
	...
	c_1234->Close();
		...
		if(Tab_jetm == "True"){
			...
			jetm<<endl<<Tab_title.c_str()<<endl;
			jetm<<endl<<Tab_QCD_EMEnriched_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_EMEnriched_all_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_BCtoE_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_BCtoE_all_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_TTbar.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoTTbar_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Wlnu.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWlnu_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WWEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWWEE_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWZEE_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_ZZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZZEE_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Z.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZ_1234->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_riga.c_str();
			jetm<<endl<<Tab_total.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_1234->GetBinContent(i) + histoQCD_BCtoE_all_1234->GetBinContent(i) + histoTTbar_1234->GetBinContent(i) + histoWlnu_1234->GetBinContent(i) + histoWWEE_1234->GetBinContent(i) + histoWZEE_1234->GetBinContent(i) + histoZZEE_1234->GetBinContent(i) + histoZ_1234->GetBinContent(i))*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Data.c_str();
	...
	c_12345->Close();
		...
		if(Tab_jetm == "True"){
			...
			jetm<<endl<<Tab_title.c_str()<<endl;
			jetm<<endl<<Tab_QCD_EMEnriched_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_EMEnriched_all_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_BCtoE_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoQCD_BCtoE_all_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_TTbar.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoTTbar_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Wlnu.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWlnu_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WWEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWWEE_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoWZEE_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_ZZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZZEE_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Z.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)(histoZ_12345->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_riga.c_str();
			jetm<<endl<<Tab_total.c_str();
			for(int i = 1; i < (MaxBin+2); i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_12345->GetBinContent(i) + histoQCD_BCtoE_all_12345->GetBinContent(i) + histoTTbar_12345->GetBinContent(i) + histoWlnu_12345->GetBinContent(i) + histoWWEE_12345->GetBinContent(i) + histoWZEE_12345->GetBinContent(i) + histoZZEE_12345->GetBinContent(i) + histoZ_12345->GetBinContent(i))*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Data.c_str();
	...
	c_123456->Close();
		...
		if(Tab_jetm == "True"){
			...
			jetm<<endl<<Tab_QCD_EMEnriched_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoQCD_EMEnriched_all_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_EMEnriched_all_err.c_str();        
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoQCD_EMEnriched_all_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_QCD_BCtoE_all.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoQCD_BCtoE_all_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_QCD_BCtoE_all_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoQCD_BCtoE_all_123456->GetBinError(i)*decimal)))/decimal<<"	";
			...
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoTTbar_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_Wlnu.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWlnu_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_Wlnu_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWlnu_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_WWEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWWEE_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WWEE_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWWEE_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_WZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWZEE_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_WZEE_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoWZEE_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_ZZEE.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoZZEE_123456->GetBinContent(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_ZZEE_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoZZEE_123456->GetBinError(i)*decimal)))/decimal<<"	";
			...
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(histoZ_123456->GetBinError(i)*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_riga.c_str();
			jetm<<endl<<Tab_total.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)((histoQCD_EMEnriched_all_123456->GetBinContent(i) + histoQCD_BCtoE_all_123456->GetBinContent(i) + histoTTbar_123456->GetBinContent(i) + histoWlnu_123456->GetBinContent(i) + histoWWEE_123456->GetBinContent(i) + histoWZEE_123456->GetBinContent(i) + histoZZEE_123456->GetBinContent(i) + histoZ_123456->GetBinContent(i))*decimal)))/decimal<<"	";
			jetm<<endl<<Tab_total_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<((float)((int)(sqrt((pow((histoQCD_EMEnriched_all_123456->GetBinError(i)),2) + pow(histoQCD_BCtoE_all_123456->GetBinError(i),2) + pow(histoTTbar_123456->GetBinError(i),2) + pow(histoWlnu_123456->GetBinError(i),2) + pow(histoWWEE_123456->GetBinError(i),2) + pow(histoWZEE_123456->GetBinError(i),2) + pow(histoZZEE_123456->GetBinError(i),2) + pow(histoZ_123456->GetBinError(i),2)))*decimal)))/decimal<<"	";
			jetm<<endl<<endl<<Tab_Data.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<histoData_123456->GetBinContent(i)<<"	";
			jetm<<endl<<Tab_Data_err.c_str();
			for(int i = 1; i < (MaxBin+2); i++) jetm<<histoData_123456->GetBinError(i)<<"	";
			jetm<<endl<<endl<<Tab_end.c_str()<<endl;
