...
string cartellaplot = "IsoJetCounter";
...
TDirectory *Dir_4;
Dir_4 = Dir_3->mkdir(cartella.c_str());
Dir_4->cd();
...
Dir_5a->cd();
	...
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoW_1->GetBinContent(i)*decimal)))/decimal<<"	";
	...
	for(int i = 1; i < 7; i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_1->GetBinContent(i) + histoQCD_BCtoE_all_1->GetBinContent(i) + histoTTbar_1->GetBinContent(i) + histoW_1->GetBinContent(i) + histoZ_1->GetBinContent(i))*decimal)))/decimal<<"	";
	...
	jetm<<endl<<Tab_W.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoW_12->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Z.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoZ_12->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_riga.c_str();
	jetm<<endl<<Tab_total.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_12->GetBinContent(i) + histoQCD_BCtoE_all_12->GetBinContent(i) + histoTTbar_12->GetBinContent(i) + histoW_12->GetBinContent(i) + histoZ_12->GetBinContent(i))*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Data.c_str();
	...
	jetm<<endl<<Tab_W.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoW_123->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Z.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoZ_123->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_riga.c_str();
	jetm<<endl<<Tab_total.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_123->GetBinContent(i) + histoQCD_BCtoE_all_123->GetBinContent(i) + histoTTbar_123->GetBinContent(i) + histoW_123->GetBinContent(i) + histoZ_123->GetBinContent(i))*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Data.c_str();
	...
	jetm<<endl<<Tab_W.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoW_1234->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Z.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoZ_1234->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_riga.c_str();
	jetm<<endl<<Tab_total.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_1234->GetBinContent(i) + histoQCD_BCtoE_all_1234->GetBinContent(i) + histoTTbar_1234->GetBinContent(i) + histoW_1234->GetBinContent(i) + histoZ_1234->GetBinContent(i))*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Data.c_str();
	...
	jetm<<endl<<Tab_W.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoW_123456->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Z.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)(histoZ_123456->GetBinContent(i)*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_riga.c_str();
	jetm<<endl<<Tab_total.c_str();
	for(int i = 1; i < 7; i++)jetm<<((float)((int)((histoQCD_EMEnriched_all_123456->GetBinContent(i) + histoQCD_BCtoE_all_123456->GetBinContent(i) + histoTTbar_123456->GetBinContent(i) + histoW_123456->GetBinContent(i) + histoZ_123456->GetBinContent(i))*decimal)))/decimal<<"	";
	jetm<<endl<<Tab_Data.c_str();
