...
string Tab_jetm = "True";                
	...
	//Background MC
	TFile* QCD_TF = TFile::Open("JetPt30/QCD_All_123456.root");
	TFile* EWK_TF = TFile::Open("JetPt30/EWK_All_123456.root");
	TFile* TTbar_TF = TFile::Open("JetPt30/TT_Pythia_123456.root");
	
	//Signal MC
	TFile *Z_TF = TFile::Open("JetPt30/Z_Madgraph_Z2_123456.root");
	
	//Data
	TFile *Data_TF = TFile::Open("JetPt30/Data_RUN2010A-B_123456.root");
	
	//Output
	string out = "recZJets_JetPt30";        
	string output = out;
	output+=".root";
...
string asseX_name;
string asseY_name;
string asseX_name_Cartella2a_JetExclRate = "exclusive multiplicity";
string asseY_name_Cartella2a_JetExclRate = Form("Events");
string asseX_name_Cartella2a_JetInclRate = "inclusive multiplicity";
string asseY_name_Cartella2a_JetInclRate = Form("Events");
string asseX_name_Cartella2a_JetPt = "leading jet p_{T} (GeV)";
string asseY_name_Cartella2a_JetPt = Form("Events/(%.0f GeV)", 1.0*rebin_jetpt); //bins da 1 GeV/c
string asseX_name_Cartella2a_JetEta = "leading jet #eta"; 
...
for(int a=1; a<5; a++){
	...
	if(a==2){
		...
		for(int n=1; n<10; n++){
			...
			double err_QCD_1_incl, err_TTbar_1_incl, err_EWK_1_incl, err_Z_1_incl, err_Data_1_incl;
			
			histoQCD_1->SetBinContent(n, histoQCD_1->IntegralAndError(n, 10, err_QCD_1_incl));
			histoQCD_1->SetBinError(n, err_QCD_1_incl);
			...
			histoEWK_1->SetBinContent(n, histoEWK_1->IntegralAndError(n, 10, err_EWK_1_incl));
			histoEWK_1->SetBinError(n, err_EWK_1_incl);
			...
			double err_QCD_12_incl, err_TTbar_12_incl, err_EWK_12_incl, err_Z_12_incl, err_Data_12_incl;
			
			histoQCD_12->SetBinContent(n, histoQCD_12->IntegralAndError(n, 10, err_QCD_12_incl));
			histoQCD_12->SetBinError(n, err_QCD_12_incl);
			...
			histoEWK_12->SetBinContent(n, histoEWK_12->IntegralAndError(n, 10, err_EWK_12_incl));
			histoEWK_12->SetBinError(n, err_EWK_12_incl);
			...
			double err_QCD_123_incl, err_TTbar_123_incl, err_EWK_123_incl, err_Z_123_incl, err_Data_123_incl;
			
			histoQCD_123->SetBinContent(n, histoQCD_123->IntegralAndError(n, 10, err_QCD_123_incl));
			histoQCD_123->SetBinError(n, err_QCD_123_incl);
			...
			histoEWK_123->SetBinContent(n, histoEWK_123->IntegralAndError(n, 10, err_EWK_123_incl));
			histoEWK_123->SetBinError(n, err_EWK_123_incl);
			...
			double err_QCD_1234_incl, err_TTbar_1234_incl, err_EWK_1234_incl, err_Z_1234_incl, err_Data_1234_incl;
			
			histoQCD_1234->SetBinContent(n, histoQCD_1234->IntegralAndError(n, 10, err_QCD_1234_incl));
			histoQCD_1234->SetBinError(n, err_QCD_1234_incl);
			...
			histoEWK_1234->SetBinContent(n, histoEWK_1234->IntegralAndError(n, 10, err_EWK_1234_incl));
			histoEWK_1234->SetBinError(n, err_EWK_1234_incl);
			...
			double err_QCD_12345_incl, err_TTbar_12345_incl, err_EWK_12345_incl, err_Z_12345_incl, err_Data_12345_incl;
			
			histoQCD_12345->SetBinContent(n, histoQCD_12345->IntegralAndError(n, 10, err_QCD_12345_incl));
			histoQCD_12345->SetBinError(n, err_QCD_12345_incl);
			...
			histoEWK_12345->SetBinContent(n, histoEWK_12345->IntegralAndError(n, 10, err_EWK_12345_incl));
			histoEWK_12345->SetBinError(n, err_EWK_12345_incl);
			...
			double err_QCD_123456_incl, err_TTbar_123456_incl, err_EWK_123456_incl, err_Z_123456_incl, err_Data_123456_incl;
			
			histoQCD_123456->SetBinContent(n, histoQCD_123456->IntegralAndError(n, 10, err_QCD_123456_incl));
			histoQCD_123456->SetBinError(n, err_QCD_123456_incl);
			...
			histoEWK_123456->SetBinContent(n, histoEWK_123456->IntegralAndError(n, 10, err_EWK_123456_incl));
			histoEWK_123456->SetBinError(n, err_EWK_123456_incl);
...
Dir_4->cd();
	 ...
	 delete histoQCD_12;
	 delete histoQCD_123;
	 delete histoQCD_1234;
	 delete histoQCD_12345;
	 delete histoQCD_123456;}
	...
	delete histoEWK_12;
	delete histoEWK_123;
	delete histoEWK_1234;
	delete histoEWK_12345;
	delete histoEWK_123456;}
