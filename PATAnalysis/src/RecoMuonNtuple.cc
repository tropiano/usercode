...
void RecoMuonNtuple::begin(TFile* out, const edm::ParameterSet& iConfig){
   ...
   zeetree->Branch("OneMuTrgMatch",&OneMuTrgMatch,"OneMuTrgMatch/I");
   ...
   zeetree->Branch(_muTrigVector[0].c_str(),&muTrg1,muTrg1_I.c_str());
   std::string muTrg2_I = _muTrigVector[1]+"/I";
   zeetree->Branch(_muTrigVector[1].c_str(),&muTrg2,muTrg2_I.c_str());
   std::string muTrg3_I = _muTrigVector[2]+"/I";
   zeetree->Branch(_muTrigVector[2].c_str(),&muTrg3,muTrg3_I.c_str());
   std::string muTrg4_I = _muTrigVector[3]+"/I";
   zeetree->Branch(_muTrigVector[3].c_str(),&muTrg4,muTrg4_I.c_str());
   std::string muTrg5_I = _muTrigVector[4]+"/I";
   zeetree->Branch(_muTrigVector[4].c_str(),&muTrg5,muTrg5_I.c_str());
   std::string muTrg6_I = _muTrigVector[5]+"/I";
   zeetree->Branch(_muTrigVector[5].c_str(),&muTrg6,muTrg6_I.c_str());
   std::string muTrg7_I = _muTrigVector[6]+"/I";
   zeetree->Branch(_muTrigVector[6].c_str(),&muTrg7,muTrg7_I.c_str());
   std::string muTrg8_I = _muTrigVector[7]+"/I";
   zeetree->Branch(_muTrigVector[7].c_str(),&muTrg8,muTrg8_I.c_str());
   std::string muTrg9_I = _muTrigVector[8]+"/I";
   zeetree->Branch(_muTrigVector[8].c_str(),&muTrg9,muTrg9_I.c_str());
   std::string muTrg10_I = _muTrigVector[9]+"/I";
   zeetree->Branch(_muTrigVector[9].c_str(),&muTrg10,muTrg10_I.c_str());
   ...
   zeetree->Branch("cutQualSYM",&cutQualSYM,"cutQualSYM/I");
   zeetree->Branch("cutQualASYM",&cutQualASYM,"cutQualASYM/I");
   zeetree->Branch("cutIsoSYM",&cutIsoSYM,"cutIsoSYM/I");
   zeetree->Branch("cutIsoASYM",&cutIsoASYM,"cutIsoASYM/I");
   zeetree->Branch("cutMuIDSYM",&cutMuIDSYM,"cutMuIDSYM/I");
   zeetree->Branch("cutMuIDASYM",&cutMuIDASYM,"cutMuIDASYM/I");
   ...
   zeetree->Branch("mugenpt1",&mugenpt1,"mugenpt1/F");
   zeetree->Branch("mugeneta1",&mugeneta1,"mugeneta1/F");
   zeetree->Branch("mugenphi1",&mugenphi1,"mugenphi1/F");
   zeetree->Branch("mugenpt2",&mugenpt2,"mugenpt2/F");
   zeetree->Branch("mugeneta2",&mugeneta2,"mugeneta2/F");
   zeetree->Branch("mugenphi2",&mugenphi2,"mugenphi2/F");
   ...
   zeetree->Branch("acc_mugenpt1",&acc_mugenpt1,"acc_mugenpt1/F");
   zeetree->Branch("acc_mugeneta1",&acc_mugeneta1,"acc_mugeneta1/F");
   zeetree->Branch("acc_mugenphi1",&acc_mugenphi1,"acc_mugenphi1/F");
   zeetree->Branch("acc_mugenpt2",&acc_mugenpt2,"acc_mugenpt2/F");
   zeetree->Branch("acc_mugeneta2",&acc_mugeneta2,"acc_mugeneta2/F");
   zeetree->Branch("acc_mugenphi2",&acc_mugenphi2,"acc_mugenphi2/F");
   ...
   zeetree->Branch("rho",&rho,"rho/F");
   zeetree->Branch("numberOfZ",&numberOfZ,"numberOfZ/I");
   zeetree->Branch("nmusall",&nmusall,"nmusall/I");
   zeetree->Branch("nmus",&nmus,"nmus/I");
   ...
   zeetree->Branch("mupt1",&mupt1,"mupt1/F");
   zeetree->Branch("mueta1",&mueta1,"mueta1/F");
   zeetree->Branch("muphi1",&muphi1,"muphi1/F");
   zeetree->Branch("mucharge1",&mucharge1,"mucharge1/F");  
   zeetree->Branch("mudB1",&mudB1,"mudB1/F");
   zeetree->Branch("mupt2",&mupt2,"mupt2/F");
   zeetree->Branch("mueta2",&mueta2,"mueta2/F");
   zeetree->Branch("muphi2",&muphi2,"muphi2/F");
   zeetree->Branch("mucharge2",&mucharge2,"mucharge2/F");   
   zeetree->Branch("mudB2",&mudB2,"mudB2/F");
   ...
   zeetree->Branch("npf2jetsele",&npf2jetsele,"npf2jetsele/I");
   zeetree->Branch("genacc_npf2jetsele",&genacc_npf2jetsele,"genacc_npf2jetsele/I");
   zeetree->Branch("pf2jetID1",&pf2jetID1,"pf2jetID1/I"); 
   zeetree->Branch("pf2jetet1",&pf2jetet1,"pf2jetet1/F"); 
   zeetree->Branch("pf2jetpt1",&pf2jetpt1,"pf2jetpt1/F");
   zeetree->Branch("pf2jeteta1",&pf2jeteta1,"pf2jeteta1/F");
   zeetree->Branch("pf2jetphi1",&pf2jetphi1,"pf2jetphi1/F");
   zeetree->Branch("pf2jecUnc1",&pf2jecUnc1,"pf2jecUnc1/F");
   zeetree->Branch("pf2jetcharge1",&pf2jetcharge1,"pf2jetcharge1/F");
   zeetree->Branch("pf2jetDeltaRa1",&pf2jetDeltaRa1,"pf2jetDeltaRa1/F");
   zeetree->Branch("pf2jetDeltaRb1",&pf2jetDeltaRb1,"pf2jetDeltaRb1/F");
   zeetree->Branch("pf2jetID2",&pf2jetID2,"pf2jetID2/I");
   zeetree->Branch("pf2jetet2",&pf2jetet2,"pf2jetet2/F"); 
   zeetree->Branch("pf2jetpt2",&pf2jetpt2,"pf2jetpt2/F");
   zeetree->Branch("pf2jeteta2",&pf2jeteta2,"pf2jeteta2/F");
   zeetree->Branch("pf2jetphi2",&pf2jetphi2,"pf2jetphi2/F");
   zeetree->Branch("pf2jecUnc2",&pf2jecUnc2,"pf2jecUnc2/F");
   zeetree->Branch("pf2jetcharge2",&pf2jetcharge2,"pf2jetcharge2/F");
   zeetree->Branch("pf2jetDeltaRa2",&pf2jetDeltaRa2,"pf2jetDeltaRa2/F");
   zeetree->Branch("pf2jetDeltaRb2",&pf2jetDeltaRb2,"pf2jetDeltaRb2/F");
   zeetree->Branch("pf2jetID3",&pf2jetID3,"pf2jetID3/I");
   zeetree->Branch("pf2jetet3",&pf2jetet3,"pf2jetet3/F"); 
   zeetree->Branch("pf2jetpt3",&pf2jetpt3,"pf2jetpt3/F");
   zeetree->Branch("pf2jeteta3",&pf2jeteta3,"pf2jeteta3/F");
   zeetree->Branch("pf2jetphi3",&pf2jetphi3,"pf2jetphi3/F");
   zeetree->Branch("pf2jecUnc3",&pf2jecUnc3,"pf2jecUnc3/F");
   zeetree->Branch("pf2jetcharge3",&pf2jetcharge3,"pf2jetcharge3/F");
   zeetree->Branch("pf2jetDeltaRa3",&pf2jetDeltaRa3,"pf2jetDeltaRa3/F");
   zeetree->Branch("pf2jetDeltaRb3",&pf2jetDeltaRb3,"pf2jetDeltaRb3/F");
...
void  RecoMuonNtuple::process(const fwlite::Event& iEvent)
{
   ...
   // Z REC events
     ...
     if(IsoJet<pat::Muon>(zrecdaughters,*pfrecjets[i]))pfisorecjets.push_back(pfrecjets[i]);}
     for(unsigned int i = 0; i < pf2recjets.size(); i++){     
     if(IsoJet<pat::Muon>(zrecdaughters,*pf2recjets[i]))pf2isorecjets.push_back(pf2recjets[i]);}
     }else if(!zrecdaughters.size()){
     for(unsigned int i = 0; i < pfrecjets.size(); i++)pfisorecjets.push_back(pfrecjets[i]);
     for(unsigned int i = 0; i < pf2recjets.size(); i++)pf2isorecjets.push_back(pf2recjets[i]);}
     
     //Reco Jets isolated from GEN Z muons in Gen Acceptance
     ...
     for(unsigned int i = 0; i < pf2recjets.size(); i++){     
     if(IsoJet<reco::Candidate>(zgendaughters,*pf2recjets[i]))geniso_pf2isorecjets.push_back(pf2recjets[i]);}
     }else if(!zgendaughters.size()){
     for(unsigned int i = 0; i < pfrecjets.size(); i++)geniso_pfisorecjets.push_back(pfrecjets[i]);
     for(unsigned int i = 0; i < pf2recjets.size(); i++)geniso_pf2isorecjets.push_back(pf2recjets[i]);}
   ...
   if (RecSelected(_RecoCutFlags[1].c_str(), *zrecHandle, *triggerHandle, run, rho)){
	...
	if((TMath::Abs(acc_jetgenphi1 - pf2jetphi1) < TMath::Pi()) && (TMath::Abs(acc_jetgenphi1 - pf2jetphi1) > -(TMath::Pi()))){
