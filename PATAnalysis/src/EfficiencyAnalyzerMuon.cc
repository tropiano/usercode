...
EfficiencyAnalyzerMuon::EfficiencyAnalyzerMuon(TFile* input, TFile* output, TFile* sec_input, std::string dirname): _dir(0), _dir1(0), _output(output), _sec_input(sec_input)  {
  //file->Open("UPDATE");
