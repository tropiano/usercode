...
//   _RecoCutFlags[_ElID] =  "_ElIDASYM";
   ...
   HoverE_Barrel_1 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Barrel_1);
   HoverE_Barrel_name+=_RecoCutFlags[2].c_str();
   HoverE_Barrel_12 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Barrel_12);
   HoverE_Barrel_name+=_RecoCutFlags[3].c_str();
   HoverE_Barrel_123 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Barrel_123);
   HoverE_Barrel_name+=_RecoCutFlags[4].c_str();
   HoverE_Barrel_1234 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Barrel_1234);
   HoverE_Barrel_name+=_RecoCutFlags[5].c_str();
   HoverE_Barrel_12345 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Barrel_12345);
   HoverE_Barrel_name+=_RecoCutFlags[6].c_str();
   HoverE_Barrel_123456 = new TH1D(HoverE_Barrel_name.c_str(), "Electron Hcal Over Ecal - Barrel", 500, 0, 0.5);
   ...
   DeltaEtaIn_Barrel_1 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Barrel_1);
   DeltaEtaIn_Barrel_name+=_RecoCutFlags[2].c_str();
   DeltaEtaIn_Barrel_12 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Barrel_12);
   DeltaEtaIn_Barrel_name+=_RecoCutFlags[3].c_str();
   DeltaEtaIn_Barrel_123 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Barrel_123);
   DeltaEtaIn_Barrel_name+=_RecoCutFlags[4].c_str();
   DeltaEtaIn_Barrel_1234 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Barrel_1234);
   DeltaEtaIn_Barrel_name+=_RecoCutFlags[5].c_str();
   DeltaEtaIn_Barrel_12345 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Barrel_12345);
   DeltaEtaIn_Barrel_name+=_RecoCutFlags[6].c_str();
   DeltaEtaIn_Barrel_123456 = new TH1D(DeltaEtaIn_Barrel_name.c_str(), "Electron Delta Eta In - Barrel", 1000, -0.1, 0.1);
   ...
   DeltaPhiIn_Barrel_1 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Barrel_1);
   DeltaPhiIn_Barrel_name+=_RecoCutFlags[2].c_str();
   DeltaPhiIn_Barrel_12 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Barrel_12);
   DeltaPhiIn_Barrel_name+=_RecoCutFlags[3].c_str();
   DeltaPhiIn_Barrel_123 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Barrel_123);
   DeltaPhiIn_Barrel_name+=_RecoCutFlags[4].c_str();
   DeltaPhiIn_Barrel_1234 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Barrel_1234);
   DeltaPhiIn_Barrel_name+=_RecoCutFlags[5].c_str();
   DeltaPhiIn_Barrel_12345 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Barrel_12345);
   DeltaPhiIn_Barrel_name+=_RecoCutFlags[6].c_str();
   DeltaPhiIn_Barrel_123456 = new TH1D(DeltaPhiIn_Barrel_name.c_str(), "Leading Electron Delta Phi In - Barrel", 400, -0.4, 0.4);
   ...
   SigmaIEtaIEta_Barrel_1= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Barrel_1);
   SigmaIEtaIEta_Barrel_name+=_RecoCutFlags[2].c_str();
   SigmaIEtaIEta_Barrel_12= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Barrel_12);
   SigmaIEtaIEta_Barrel_name+=_RecoCutFlags[3].c_str();
   SigmaIEtaIEta_Barrel_123= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Barrel_123);
   SigmaIEtaIEta_Barrel_name+=_RecoCutFlags[4].c_str();
   SigmaIEtaIEta_Barrel_1234= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Barrel_1234);
   SigmaIEtaIEta_Barrel_name+=_RecoCutFlags[5].c_str();
   SigmaIEtaIEta_Barrel_12345= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Barrel_12345);
   SigmaIEtaIEta_Barrel_name+=_RecoCutFlags[6].c_str();
   SigmaIEtaIEta_Barrel_123456= new TH1D(SigmaIEtaIEta_Barrel_name.c_str(), "Electron SigmaIEtaIEta - Barrel", 1000, 0, 0.1);
   ...
   HoverE_Endcap_1 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Endcap_1);
   HoverE_Endcap_name+=_RecoCutFlags[2].c_str();
   HoverE_Endcap_12 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Endcap_12);
   HoverE_Endcap_name+=_RecoCutFlags[3].c_str();
   HoverE_Endcap_123 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Endcap_123);
   HoverE_Endcap_name+=_RecoCutFlags[4].c_str();
   HoverE_Endcap_1234 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Endcap_1234);
   HoverE_Endcap_name+=_RecoCutFlags[5].c_str();
   HoverE_Endcap_12345 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   _histoVector.push_back(HoverE_Endcap_12345);
   HoverE_Endcap_name+=_RecoCutFlags[6].c_str();
   HoverE_Endcap_123456 = new TH1D(HoverE_Endcap_name.c_str(), "Electron Hcal Over Ecal - Endcap", 500, 0, 0.5);
   ...
   DeltaEtaIn_Endcap_1 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Endcap_1);
   DeltaEtaIn_Endcap_name+=_RecoCutFlags[2].c_str();
   DeltaEtaIn_Endcap_12 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Endcap_12);
   DeltaEtaIn_Endcap_name+=_RecoCutFlags[3].c_str();
   DeltaEtaIn_Endcap_123 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Endcap_123);
   DeltaEtaIn_Endcap_name+=_RecoCutFlags[4].c_str();
   DeltaEtaIn_Endcap_1234 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Endcap_1234);
   DeltaEtaIn_Endcap_name+=_RecoCutFlags[5].c_str();
   DeltaEtaIn_Endcap_12345 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   _histoVector.push_back(DeltaEtaIn_Endcap_12345);
   DeltaEtaIn_Endcap_name+=_RecoCutFlags[6].c_str();
   DeltaEtaIn_Endcap_123456 = new TH1D(DeltaEtaIn_Endcap_name.c_str(), "Electron Delta Eta In - Endcap", 1000, -0.1, 0.1);
   ...
   DeltaPhiIn_Endcap_1 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Endcap_1);
   DeltaPhiIn_Endcap_name+=_RecoCutFlags[2].c_str();
   DeltaPhiIn_Endcap_12 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Endcap_12);
   DeltaPhiIn_Endcap_name+=_RecoCutFlags[3].c_str();
   DeltaPhiIn_Endcap_123 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Endcap_123);
   DeltaPhiIn_Endcap_name+=_RecoCutFlags[4].c_str();
   DeltaPhiIn_Endcap_1234 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Endcap_1234);
   DeltaPhiIn_Endcap_name+=_RecoCutFlags[5].c_str();
   DeltaPhiIn_Endcap_12345 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   _histoVector.push_back(DeltaPhiIn_Endcap_12345);
   DeltaPhiIn_Endcap_name+=_RecoCutFlags[6].c_str();
   DeltaPhiIn_Endcap_123456 = new TH1D(DeltaPhiIn_Endcap_name.c_str(), "Leading Electron Delta Phi In - Endcap", 400, -0.4, 0.4);
   ...
   SigmaIEtaIEta_Endcap_1= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Endcap_1);
   SigmaIEtaIEta_Endcap_name+=_RecoCutFlags[2].c_str();
   SigmaIEtaIEta_Endcap_12= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Endcap_12);
   SigmaIEtaIEta_Endcap_name+=_RecoCutFlags[3].c_str();
   SigmaIEtaIEta_Endcap_123= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Endcap_123);
   SigmaIEtaIEta_Endcap_name+=_RecoCutFlags[4].c_str();
   SigmaIEtaIEta_Endcap_1234= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Endcap_1234);
   SigmaIEtaIEta_Endcap_name+=_RecoCutFlags[5].c_str();
   SigmaIEtaIEta_Endcap_12345= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
   _histoVector.push_back(SigmaIEtaIEta_Endcap_12345);
   SigmaIEtaIEta_Endcap_name+=_RecoCutFlags[6].c_str();
   SigmaIEtaIEta_Endcap_123456= new TH1D(SigmaIEtaIEta_Endcap_name.c_str(), "Electron SigmaIEtaIEta - Endcap", 1000, 0, 0.1);
...
void  RecoElectron::process(const fwlite::Event& iEvent){
	...
	if(zrecHandleSC->size()){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), *zrecHandleSC, *triggerHandle, _run, _rho)){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho)){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho)){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho)){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    ...
		    RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[5].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho)){
		...
		if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    ...
		    RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[5].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho) && 
		    RecSelected_ele(_RecoCutFlags[6].c_str(), (*zrecHandleSC), *triggerHandle, _run, _rho)){
	...
	if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
	...
	if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
	...
	if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
	...
	if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[5].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
	...
	if (RecSelected_ele(_RecoCutFlags[1].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[2].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[3].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[4].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[5].c_str(), (*zrecHandle), *triggerHandle, _run, _rho) && RecSelected_ele(_RecoCutFlags[6].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
...
//	ElIDFlag="_ElIDASYM";
	...
	if(RecSelected_ele(_RecoCutFlags[n].c_str(), (*zrecHandle), *triggerHandle, _run, _rho)){
	PreIso = true;
	}else{
	PreIso = false;
	n = fcount+1;
