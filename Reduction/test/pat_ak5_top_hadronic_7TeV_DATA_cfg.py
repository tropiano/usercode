...
process.load("UserCode.Test.recTTbarPatAddOns_cff")
...
addJetCollection(process, cms.InputTag('ak5PFJets'), 'PF', '',
                 doJTA=True, doBTagging=True,jetCorrLabel=('AK5', 'PF'),
...
process.jetTriggerMatch = cms.EDFilter( "PATTriggerMatcherDRLessByR",
    ...
    filterIds      = cms.vint32( 0 ),
    filterLabels   = cms.vstring( '*' ),
    pathNames      = cms.vstring( 'HLT_Jet15U', 'HLT_Jet30U', 'HLT_QuadJet15'),
    collectionTags = cms.vstring( '*' ),
    maxDeltaR = cms.double( 0.2 ),
    resolveAmbiguities    = cms.bool( True ),
    resolveByMatchQuality = cms.bool( False )
...
#################
from UserCode.Test.recTTbarPatAddOns_cff import ttbarrecEventContent
from UserCode.Test.recZeePatAddOns_cff import zeerecEventContent
from UserCode.Test.recJetPatAddOns_cff import jetrecEventContent
...
process.out.fileName = 'outCrabTopBtag.root'
