...
#process.ttbarrec.cut = cms.string('0 < mass < 130')
...
#from Firenze.Reduction.recTTbarPatAddOns_cff import ttbargenEventContent
...
#process.out.outputCommands.extend(ttbargenEventContent)
...
process.out.fileName = 'outTopBtag.root'
