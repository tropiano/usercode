...
## uncomment here
process.source.fileNames = ['file:RECO2.root']
...
process.offsetCorrection = cms.Sequence(process.ak5PFJets * process.kt6PFJets * process.ak5PFJetsL1FastL2L3Residual)

addJetCollection(process,cms.InputTag('ak5PFJetsL1FastL2L3Residual'),
                  'AK5', 'PFL1corrected',
                  doJTA        = True,
                  doBTagging   = True,
                  jetCorrLabel = ('AK5PF', cms.vstring(['L2Relative', 'L3Absolute','L2L3Residual'])),
...
process.out.fileName = 'Data_Run2010A_Dec22ReReco.root'
